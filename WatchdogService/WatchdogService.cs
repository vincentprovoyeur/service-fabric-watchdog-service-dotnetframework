    ...
    internal sealed class WatchdogService : StatefulService, IWatchdogService
    {
        ...
        internal async Task RegisterHealthCheckAsync(CancellationToken token)
        {
            ...
            try
            {
                ...
                ServiceEventSource.Current.Trace($"RegisterHealthCheckAsync:  RegisterHealthCheckAsync called ");
        ...
        private void ReportWatchdogHealth()
        {
            ...
            try
            {
                ...
                ServiceEventSource.Current.Trace($"RunAsync:ReportWatchdogHealth INFO: ReportWatchdogHealth for WatchdogServiceHealth...");
                ...
                ServiceEventSource.Current.Trace($"RunAsync:ReportWatchdogHealth INFO: ReportWatchdogHealth for HealthCheckOperations...");
                this.Partition.ReportPartitionHealth(hi);
                ...
                hi.RemoveWhenExpired = false;
                hi.SequenceNumber = HealthInformation.AutoSequenceNumber;
                ServiceEventSource.Current.Trace($"RunAsync:ReportWatchdogHealth INFO: ReportWatchdogHealth for MetricOperations...");
                this.Partition.ReportPartitionHealth(hi);
