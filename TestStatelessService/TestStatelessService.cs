...
namespace TestStatelessService
{
    ...
    internal sealed class TestStatelessService : StatelessService
    {
        ...
        internal async Task<bool> RegisterHealthCheckAsync(CancellationToken token)
        {
            ...
            string jsonTemplate =
                "{{\"name\":\"UniqueHealthCheckNameForTestStatelessApp\",\"serviceName\": \"{0}\",\"partition\": \"{1}\",\"frequency\": \"{2}\",\"suffixPath\": \"api/values\",\"method\": {{ \"Method\": \"GET\" }}, \"expectedDuration\": \"00:00:00.2000000\",\"maximumDuration\": \"00:00:05\" }}";
